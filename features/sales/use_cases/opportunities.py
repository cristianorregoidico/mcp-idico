...
from features.sales.queries.opportunities import get_opportunities_data
...
def execute(initial_date: str, final_date: str, inside_sales: str, customer_name: str) -> Dict[str, Any]:
    sql, params = get_opportunities_data(initial_date, final_date, inside_sales, customer_name)
