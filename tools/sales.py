...
from connections.netsuite_querys import get_quotes_by_inside, get_sales_orders_by_inside, get_bookings_data, get_items_quoted_by_customer, get_opportunities_data, get_sold_items_by_period
...
from analitycs.sales import finance_summary, opportunity_summary, summarize_sold_items
from connections.postgresql_querys import get_customer_imports_data
from connections.postgresql import execute_pg_query_dev
from analitycs.operations import build_imports_summary
...
def get_customer_imports(customer_name: str) -> Dict[str, Any]:
    """Retrieve the imports summary for a given customer from 2023 to 2025.
