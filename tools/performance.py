...
from analitycs.sales import analyze_inside_sales
from connections.postgresql_querys import get_scorecard_by_is_month, get_scorecard_by_is_daily, get_scorecard_by_is_year
